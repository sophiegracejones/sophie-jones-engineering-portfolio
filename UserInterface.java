...
public class UserInterface {
    ...
    public static void menu() {
        ...
        while (true) {
            ...
            System.out.println("Alive Players: " + Management.alivePlayers.size() + " | Dead Players: " + Management.deadPlayers.size());
            System.out.println("Alive Teams: " + Management.aliveTeams.size() + " | Dead Teams: " + Management.deadTeams.size());
    ...
    public static void mostKills()
    {
        ...
        tempList.addAll(Management.teamList);
        ...
        for(int i = 0; i < tempList.size() - 1; i++)
        {
            ...
            {
                if (tempList.get(j).getTotalKills() < tempList.get(minIndex).getTotalKills())
                {
                    minIndex = j;
                }
            }
            Team temp = tempList.get(minIndex);
        ...
        for(int i = 1; i <= 10; i++)
        {
            Team team = tempList.get(tempList.size() - i);
            System.out.println(i + "." + team.getName() + "(" + team.getTotalKills() + " kills)");
            System.out.println("Members: " + team.getMembers()[0].getName() + " " + team.getMembers()[1].getName());
        }
    ...
    public static void roundControl()
    {
        ...
        while (true) {
            ...
            System.out.println("(3) Randomize Targets");
            System.out.println("(3) Back");
